...
public:
	...
	virtual std::string get_header(const std::string& key, const std::string& default_value) = 0;
	...
	virtual void set_cookies(const collections::Dictionary<std::string, Cookie>& cookies) = 0;
