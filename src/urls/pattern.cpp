...
UrlPattern::UrlPattern(const std::string& rgx, const wasp::ViewHandler& handler, const std::string& name)
{
...
wasp::http::HttpResponse* UrlPattern::apply(wasp::http::HttpRequest* request, Args* args, ILogger* logger)
{
