...
#ifndef WASP_UNIT_TESTS_CORE_EXCEPTIONS_FILE_DOES_NOT_EXIST_ERROR_TESTS_H
#define WASP_UNIT_TESTS_CORE_EXCEPTIONS_FILE_DOES_NOT_EXIST_ERROR_TESTS_H
...
public:
	...
	wasp::FileDoesNotExistError ConstCharConstructorError;
	wasp::FileDoesNotExistError StringConstructorError;
...
#endif // WASP_UNIT_TESTS_CORE_EXCEPTIONS_FILE_DOES_NOT_EXIST_ERROR_TESTS_H
