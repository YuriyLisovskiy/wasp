...
#ifndef WASP_UNIT_TESTS_CORE_EXCEPTIONS_PARSE_ERROR_TESTS_H
#define WASP_UNIT_TESTS_CORE_EXCEPTIONS_PARSE_ERROR_TESTS_H
...
#endif // WASP_UNIT_TESTS_CORE_EXCEPTIONS_PARSE_ERROR_TESTS_H
