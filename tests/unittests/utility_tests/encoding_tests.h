...
#ifndef WASP_UNIT_TESTS_UTILITY_TESTS_ENCODING_TESTS_H
#define WASP_UNIT_TESTS_UTILITY_TESTS_ENCODING_TESTS_H

#include <gtest/gtest.h>

#include "../_def_.h"
#include "../../../src/utility/encoding.h"
...
TEST(EncodeUrlTestCase, encode)
{
	...
	ASSERT_EQ(encoding::encodeUrl(toEncode), expected);
...
#endif // WASP_UNIT_TESTS_UTILITY_TESTS_ENCODING_TESTS_H
