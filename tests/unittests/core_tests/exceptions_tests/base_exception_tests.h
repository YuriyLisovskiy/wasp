...
#ifndef WASP_UNIT_TESTS_CORE_TESTS_EXCEPTIONS_TESTS_WASP_ERROR_TESTS_H
#define WASP_UNIT_TESTS_CORE_TESTS_EXCEPTIONS_TESTS_WASP_ERROR_TESTS_H
...
#endif // WASP_UNIT_TESTS_CORE_TESTS_EXCEPTIONS_TESTS_WASP_ERROR_TESTS_H
