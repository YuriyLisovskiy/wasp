...
#ifndef WASP_UNIT_TESTS_CORE_TESTS_EXCEPTIONS_TESTS_VALUE_ERROR_TESTS_H
#define WASP_UNIT_TESTS_CORE_TESTS_EXCEPTIONS_TESTS_VALUE_ERROR_TESTS_H
...
public:
	...
	wasp::ValueError ConstCharConstructorError;
	wasp::ValueError StringConstructorError;
...
#endif // WASP_UNIT_TESTS_CORE_TESTS_EXCEPTIONS_TESTS_VALUE_ERROR_TESTS_H
