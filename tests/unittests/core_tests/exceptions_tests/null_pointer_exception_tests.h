...
#ifndef WASP_UNIT_TESTS_CORE_TESTS_EXCEPTIONS_TESTS_NULL_POINTER_EXCEPTION_TESTS_H
#define WASP_UNIT_TESTS_CORE_TESTS_EXCEPTIONS_TESTS_NULL_POINTER_EXCEPTION_TESTS_H
...
#endif // WASP_UNIT_TESTS_CORE_TESTS_EXCEPTIONS_TESTS_NULL_POINTER_EXCEPTION_TESTS_H
