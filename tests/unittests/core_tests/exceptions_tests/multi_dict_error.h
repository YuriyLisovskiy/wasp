...
#ifndef WASP_UNIT_TESTS_CORE_TESTS_EXCEPTIONS_TESTS_MULTI_DICT_ERROR_TESTS_H
#define WASP_UNIT_TESTS_CORE_TESTS_EXCEPTIONS_TESTS_MULTI_DICT_ERROR_TESTS_H
...
public:
	...
	wasp::MultiValueDictError ConstCharConstructorError;
	wasp::MultiValueDictError StringConstructorError;
...
#endif // WASP_UNIT_TESTS_CORE_TESTS_EXCEPTIONS_TESTS_MULTI_DICT_ERROR_TESTS_H
