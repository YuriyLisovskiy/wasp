...
#ifndef WASP_UNIT_TESTS_CORE_TESTS_EXCEPTIONS_TESTS_PARSE_ERROR_TESTS_H
#define WASP_UNIT_TESTS_CORE_TESTS_EXCEPTIONS_TESTS_PARSE_ERROR_TESTS_H
...
public:
	...
	wasp::ParseError ConstCharConstructorError;
	wasp::ParseError StringConstructorError;
...
#endif // WASP_UNIT_TESTS_CORE_TESTS_EXCEPTIONS_TESTS_PARSE_ERROR_TESTS_H
