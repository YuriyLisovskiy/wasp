...
#ifndef WASP_UNIT_TESTS_COLLECTIONS_MULTI_DICT_TESTS_H
#define WASP_UNIT_TESTS_COLLECTIONS_MULTI_DICT_TESTS_H
...
#endif // WASP_UNIT_TESTS_COLLECTIONS_MULTI_DICT_TESTS_H
