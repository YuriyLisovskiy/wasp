...
#ifndef WASP_UNIT_TESTS_HTTP_TESTS_URL_TESTS_H
#define WASP_UNIT_TESTS_HTTP_TESTS_URL_TESTS_H
...
protected:
	...
	void SetUp() override
	{
		this->url = new wasp::http::Url(STR_URL_EXPECTED);
	}
...
#endif // WASP_UNIT_TESTS_HTTP_TESTS_URL_TESTS_H
